...
%{
    ...
    /**
     * Resets the Groovy tracked state; {@inheritDoc}
     */
    @Override
    public void reset() {
        super.reset();
    ...
    /**
     * Gets the constant value created by JFlex to represent GROOVYDOC.
     */
    @Override
    int GROOVYDOC() { return GROOVYDOC; }
...
%include GroovyProductions.lexh
