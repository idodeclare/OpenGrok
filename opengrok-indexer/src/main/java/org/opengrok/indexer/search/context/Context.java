...
public class Context {
     ...
     * limited. N.b. unlike
     * {@link #getContext(org.opengrok.indexer.configuration.RuntimeEnvironment, java.io.Reader, java.io.Writer, java.lang.String, java.lang.String, java.lang.String, org.opengrok.indexer.analysis.Definitions, boolean, boolean, java.util.List, org.opensolaris.opengrok.analysis.Scopes)},
            ...
            for (LineMatcher m1 : m) {
                if (m1.match(tag.symbol) == LineMatcher.MATCHED) {
                    ...
                    TagDesc desc = new TagDesc(tag.symbol,
                            Integer.toString(tag.line), tag.type, tag.text,
                            scope);
