...
public class JFlexTokenizer extends Tokenizer implements SymbolMatchedListener,
     ...
     * {@link #setTokenizerMode(org.opengrok.indexer.analysis.TokenizerMode)}
     ...
     * {@link #setAttribs(org.opengrok.indexer.analysis.PendingToken)}
     * upon the former.
    ...
    private void addPlainTokens(String fullsub, int offset) {
        ...
        if (plainTokenizer == null) {
            plainTokenizer = new PlainFullTokenizer(AbstractAnalyzer.DUMMY_READER);
    ...
    private static class PendingSub {
        ...
        PendingSub(String str, int start) {
            this.str = str;
            this.start = start;
        }
    }
