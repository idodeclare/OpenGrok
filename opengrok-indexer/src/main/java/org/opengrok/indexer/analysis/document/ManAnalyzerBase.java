...
/**
 * Represents an abstract base class for analyzers for man page documents.
 * Created on September 30, 2005
 * @author Chandan
 */
public abstract class ManAnalyzerBase extends TextAnalyzer {

    /**
     * Creates a new instance for the specified factory and matcher.
     * @param factory defined instance
     * @param matcher defined instance
     */
    protected ManAnalyzerBase(
            AnalyzerFactory factory, ScanningSymbolMatcher matcher) {
        super(factory, new JFlexTokenizer(matcher));
    }
