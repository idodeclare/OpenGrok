...
public class CtagsParserTest {
    ...
    public void ctags_vs_universal_ctags() throws Exception {
        ...
        String uc_cxx = "TEST\tsample.cxx\t/^#define TEST($/;\"\tmacro\tline:7\tsignature:(x)\n"
                ...
                + "MemberFunc\tsample.cxx\t/^    int MemberFunc(int a, int b) const {$/;\"\tfunction\tline:22\tclass:SomeClass\ttyperef:typename:int\tsignature:(int a, int b) const\n"
                + "operator ++\tsample.cxx\t/^    int operator++(int) {$/;\"\tfunction\tline:27\tclass:SomeClass\ttyperef:typename:int\tsignature:(int)\n"
                + "TemplateMember\tsample.cxx\t/^    size_t TemplateMember(std::vector<T>& v) {$/;\"\tfunction\tline:32\tclass:SomeClass\ttyperef:typename:size_t\tsignature:(std::vector<T>& v)\n"
                ...
                + "SomeFunc\tsample.cxx\t/^        static void SomeFunc(const std::string& arg) {$/;\"\tfunction\tline:44\tclass:ns1::NamespacedClass\ttyperef:typename:void\tsignature:(const std::string& arg)\n"
                + "ns2\tsample.cxx\t/^    namespace ns2 {$/;\"\tnamespace\tline:49\tnamespace:ns1\n"
                + "foo\tsample.cxx\t/^        int foo(int a, int b) {$/;\"\tfunction\tline:51\tnamespace:ns1::ns2\ttyperef:typename:int\tsignature:(int a, int b)\n"
                ...
                + "main\tsample.cxx\t/^int main(int argc, char *argv[]) {$/;\"\tfunction\tline:76\ttyperef:typename:int\tsignature:(int argc, char *argv[])\n"
        ...
        String c_cxx = "TEST\tsample.cxx\t7;\"\tmacro\tline:7\n"
                ...
                + "MemberFunc\tsample.cxx\t/^    int MemberFunc(int a, int b) const {$/;\"\tfunction\tline:22\tclass:SomeClass\tsignature:(int a, int b) const\n"
                + "operator ++\tsample.cxx\t/^    int operator++(int) {$/;\"\tfunction\tline:27\tclass:SomeClass\tsignature:(int)\n"
                + "TemplateMember\tsample.cxx\t/^    size_t TemplateMember(std::vector<T>& v) {$/;\"\tfunction\tline:32\tclass:SomeClass\tsignature:(std::vector<T>& v)\n"
                + "attr_\tsample.cxx\t/^    int attr_;$/;\"\tmember\tline:37\tclass:SomeClass\n"
                + "ns1\tsample.cxx\t/^namespace ns1 {$/;\"\tnamespace\tline:40\n"
                + "NamespacedClass\tsample.cxx\t/^    class NamespacedClass {$/;\"\tclass\tline:42\tnamespace:ns1\n"
                + "SomeFunc\tsample.cxx\t/^        static void SomeFunc(const std::string& arg) {$/;\"\tfunction\tline:44\tclass:ns1::NamespacedClass\tsignature:(const std::string& arg)\n"
        ...
        String uc_java = "org.opengrok.indexer.analysis.java\thome/jobs/OpenGrokAnt/workspace/testdata/sources/java/Sample.java\t/^package org.opengrok.indexer.analysis.java;$/;\"\tpackage\tline:23\n"
                ...
                + "Method\thome/jobs/OpenGrokAnt/workspace/testdata/sources/java/Sample.java\t/^    public int Method(int arg) {$/;\"\tmethod\tline:33\tclass:Sample\tsignature:(int arg)\n"
                + "res\thome/jobs/OpenGrokAnt/workspace/testdata/sources/java/Sample.java\t/^        int res = 5;$/;\"\tlocal\tline:34\n"
                + "i\thome/jobs/OpenGrokAnt/workspace/testdata/sources/java/Sample.java\t/^        InnerClass i = new InnerClass();$/;\"\tlocal\tline:38\n"
                + "AbstractMethod\thome/jobs/OpenGrokAnt/workspace/testdata/sources/java/Sample.java\t/^    public abstract int AbstractMethod(int test);$/;\"\tmethod\tline:43\tclass:Sample\tsignature:(int test)\n"
                + "InnerClass\thome/jobs/OpenGrokAnt/workspace/testdata/sources/java/Sample.java\t/^    private class InnerClass {$/;\"\tclass\tline:45\tclass:Sample\n"
                + "InnerMethod\thome/jobs/OpenGrokAnt/workspace/testdata/sources/java/Sample.java\t/^        public String InnerMethod() {$/;\"\tmethod\tline:47\tclass:Sample.InnerClass\tsignature:()\n"
                + "main\thome/jobs/OpenGrokAnt/workspace/testdata/sources/java/Sample.java\t/^    public static void main(String args[]) {$/;\"\tmethod\tline:60\tclass:Sample\tsignature:(String args[])\n"
        ...
        String c_java = "org.opengrok.indexer.analysis.java\thome/jobs/OpenGrokAnt/workspace/testdata/sources/java/Sample.java\t/^package org.opengrok.indexer.analysis.java;$/;\"\tpackage\tline:23\n"
                + "Sample\thome/jobs/OpenGrokAnt/workspace/testdata/sources/java/Sample.java\t/^public class Sample {$/;\"\tclass\tline:25\n"
                + "MY_MEMBER\thome/jobs/OpenGrokAnt/workspace/testdata/sources/java/Sample.java\t/^    static private String MY_MEMBER = \"value\";$/;\"\tfield\tline:27\tclass:Sample\n"
                + "Sample\thome/jobs/OpenGrokAnt/workspace/testdata/sources/java/Sample.java\t/^    public Sample() {$/;\"\tmethod\tline:29\tclass:Sample\tsignature:()\n"
                + "Method\thome/jobs/OpenGrokAnt/workspace/testdata/sources/java/Sample.java\t/^    public int Method(int arg) {$/;\"\tmethod\tline:33\tclass:Sample\tsignature:(int arg)\n"
